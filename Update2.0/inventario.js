...
let inventory = JSON.parse(localStorage.getItem('inventory')) || [
    {
        ...
        stock: 50,
        minStock: 20,
        cost: 70.00, // Kept in initial data for structure, but won't be edited/added via form
        price: 105.00, // Kept in initial data for structure, but won't be edited/added via form
        expiry: "2023-12-15",
